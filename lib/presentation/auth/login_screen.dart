...
import 'package:test/application/auth/auth_event.dart';
import 'package:test/application/core/utils/enums.dart';
import 'package:test/presentation/auth/register_screen.dart';
                  ...
                  BlocConsumer<AuthBloc, AuthState>(
                    listener: (context, state) {
                      if (state.authState == ApiState.success) {
                        Fluttertoast.showToast(msg: "Logged in Sccessfully");
